...
class TransactionController extends Controller
{
    ...
    public function exportCsv(Request $request): StreamedResponse
    {
        ...
        $columns = ['Tanggal', 'Keterangan', 'Kategori', 'Dompet', 'Jenis', 'Nominal', 'Catatan'];
        ...
        return response()->streamDownload($callback, 'transaksi.csv', $headers);
    }
    ...
    protected function validateTransaction(Request $request): array
    {
        ...
        $validator->after(function ($validator) use ($request) {
            ...
            if ($category && $type && $category->type !== $type) {
                $validator->errors()->add('type', 'Jenis transaksi harus sesuai dengan jenis kategori.');
            }
        });
